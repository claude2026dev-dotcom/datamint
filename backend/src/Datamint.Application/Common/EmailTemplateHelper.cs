...
{
    public static string Wrap(string title, string greeting, string bodyHtml, string? ctaLabel = null, string? ctaUrl = null)
    {
        ...
        return $"""
            <div style="background:#f2f3f8;padding:32px 16px;font-family:-apple-system,Segoe UI,Roboto,sans-serif;">
              <div style="max-width:480px;margin:0 auto;background:#ffffff;border:1px solid #e3e5f0;border-radius:14px;padding:32px;">
                ...
                {button}
                <p style="color:#767b93;font-size:12px;margin-top:28px;border-top:1px solid #e3e5f0;padding-top:16px;">Datamint — AI-powered PDF data extraction.</p>
              </div>
            </div>
            """;
    }
