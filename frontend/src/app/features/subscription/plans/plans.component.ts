  ...
  template: `
    <div class="dm-container page">
      ...
      @if (error) {
        ...
        <p class="muted center">No paid plans are available yet — check back soon.</p>
      } @else {
      <div class="plan-grid">
...
export class PlansComponent implements OnInit {
  ...
  choosePlan(plan: Plan) {
    if (!this.auth.isLoggedIn()) { this.router.navigateByUrl(`/login?returnUrl=${encodeURIComponent('/plans')}`); return; }
