...
@Component({
  ...
  template: `
    <section class="hero" [@staggerIn]>
      ...
      <div class="dm-container hero-inner">
        <span class="badge reveal">✨ AI-powered PDF data extraction</span>
  ...
  styles: [`
    ...
    .badge { display: inline-block; padding: 6px 14px; border-radius: 999px; background: var(--dm-surface); border: 1px solid var(--dm-border); font-size: 0.8rem; color: var(--dm-accent); }
    ...
    .mock-arrow { color: var(--dm-primary-light); font-size: 1.4rem; }
