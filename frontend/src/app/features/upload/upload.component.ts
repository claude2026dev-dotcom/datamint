...
@Component({
  ...
  styles: [`
    ...
    .mode-option { display: flex; gap: 12px; align-items: flex-start; padding: 10px 12px; margin: 0 -12px; border-radius: var(--dm-radius-sm); cursor: pointer; border: 1px solid transparent; }
